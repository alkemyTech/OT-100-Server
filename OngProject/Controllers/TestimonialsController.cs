...
namespace OngProject.Controllers
{
    ...
    public class TestimonialsController : ControllerBase
    {
        ...
        [SwaggerOperation(Summary = "Create Testimony.",Description = "Requires admin privileges.")]
        [SwaggerResponse(200, "Created. Returns id of the created testimony.", typeof(int))]
